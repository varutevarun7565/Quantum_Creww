...
data class SosTriggerRequest(val lat: Double, val lng: Double)
...
data class HospitalDto(
    ...
    val phone: String?, val beds: Int?, val lat: Double?, val lng: Double?,
)

data class AmbulancePositionRequest(val lat: Double, val lng: Double, val etaMin: Int?)
